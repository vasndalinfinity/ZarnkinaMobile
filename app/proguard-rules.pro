...
-keep class com.zarnkina.mobile.bridge.** { *; }
-keep class com.zarnkina.mobile.utils.device.VulkanChecker {
    *;
}
-keep class com.zarnkina.mobile.utils.device.VulkanCapabilities {
    *;
}
-keep interface com.zarnkina.mobile.utils.device.VulkanLogCallback {
    *;
}
-keep class com.zarnkina.mobile.game.input.CriticalNativeTest {
    *;
}
