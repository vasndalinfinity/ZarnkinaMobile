...
JNIEXPORT void JNICALL
Java_com_zarnkina_mobile_game_sdl_SdlBridge_initializeControllerSubsystems(__attribute__((unused)) JNIEnv* env, __attribute__((unused)) jclass clazz) {
...
static bool tryCriticalNative(JNIEnv *env) {
    ...
    jclass criticalNativeTest = (*env)->FindClass(env, "com/zarnkina/mobile/game/input/CriticalNativeTest");
