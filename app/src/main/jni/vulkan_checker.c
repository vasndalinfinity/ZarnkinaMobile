...
Java_com_zarnkina_mobile_utils_device_VulkanChecker_nativeSetLogCallback(
        JNIEnv *env,
        jclass clazz,
        jobject callback
) {
...
Java_com_zarnkina_mobile_utils_device_VulkanChecker_nativeCheckVulkan(
        JNIEnv *env,
        jclass clazz,
        jstring jDriverPath,
        jstring jNativeDir,
    ...
    VkApplicationInfo appInfo = {
            ...
            .pApplicationName = "ZarnkinaMobile",
...
#undef PUT_FEAT
    ...
    jclass capClass = (*env)->FindClass(env, "com/zarnkina/mobile/utils/device/VulkanCapabilities");
