...
import static com.zarnkina.mobile.bridge.ZLBridgeStatesKt.CURSOR_DISABLED;
import static com.zarnkina.mobile.bridge.ZLBridgeStatesKt.CURSOR_ENABLED;
...
import com.zarnkina.mobile.bridge.NativeLibraryLoader;
import com.zarnkina.mobile.bridge.ZLBridgeStates;
import com.zarnkina.mobile.bridge.ZLNativeInvoker;
import com.zarnkina.mobile.context.ContextsKt;
import com.zarnkina.mobile.game.input.EfficientAndroidLWJGLKeycode;
import com.zarnkina.mobile.game.sdl.DirectGamepadEnableHandler;
...
public class CallbackBridge {
    ...
    public static boolean notifyLauncher(int type, int... action) {
        if (action == null || action.length == 0) {
            LoggerBridge.append("ZarnkinaMobile: SDL notification has no action");
            return false;
        }
        switch (type) {
            case NOTIF_TYPE_SDL:
                if (action[0] == ACTION_INIT_LAUNCHER_INTEGRATION) {
                    ...
                    try {
                        LoggerBridge.append("ZarnkinaMobile: loading SDL3");
                        System.loadLibrary("SDL3");
                        LoggerBridge.append("ZarnkinaMobile: loading SDL2");
                        System.loadLibrary("SDL2");
                        LoggerBridge.append("ZarnkinaMobile: setting up SDL JNI");
                        SdlBridge.setupJNI();
                        LoggerBridge.append("ZarnkinaMobile: binding SDL surface");
                        ...
                        LoggerBridge.append("ZarnkinaMobile: SDL support enabled!");
                        return true;
                    } catch (Throwable e) {
                        ...
                        LoggerBridge.append("ZarnkinaMobile: SDL launcher integration is unavailable:\n" + trace);
                    }
                }
    ...
    private static void onDirectInputEnable() {
        LoggerBridge.append("ZarnkinaMobile: Direct gamepad input enabled");
