...
import com.zarnkina.mobile.bridge.LoggerBridge
import com.zarnkina.mobile.bridge.ZLBridge
import com.zarnkina.mobile.bridge.ZLBridgeStates
import com.zarnkina.mobile.coroutine.DataBridge
import com.zarnkina.mobile.game.account.Account
import com.zarnkina.mobile.game.input.AWTCharSender
import com.zarnkina.mobile.game.input.CharacterSenderStrategy
import com.zarnkina.mobile.game.input.LWJGLCharSender
import com.zarnkina.mobile.game.launch.GameLauncher
import com.zarnkina.mobile.game.launch.GameService
import com.zarnkina.mobile.game.launch.JvmLaunchInfo
import com.zarnkina.mobile.game.launch.JvmLauncher
import com.zarnkina.mobile.game.launch.LaunchConfig
import com.zarnkina.mobile.game.launch.Launcher
import com.zarnkina.mobile.game.launch.handler.AbstractHandler
import com.zarnkina.mobile.game.launch.handler.GameHandler
import com.zarnkina.mobile.game.launch.handler.HandlerType
import com.zarnkina.mobile.game.launch.handler.JVMHandler
...
import com.zarnkina.mobile.terracotta.TerracottaVPNService
...
import com.zarnkina.mobile.ui.control.input.HidableInputLayout
import com.zarnkina.mobile.ui.control.input.TextInputMode
import com.zarnkina.mobile.ui.screens.game.elements.OpenFolderLayer
import com.zarnkina.mobile.ui.screens.game.elements.OpenFolderOperation
import com.zarnkina.mobile.ui.theme.ZarnkinaMobileTheme
import com.zarnkina.mobile.ui.toAndroidString
import com.zarnkina.mobile.utils.device.PhysicalMouseChecker
import com.zarnkina.mobile.utils.getDisplayFriendlyRes
import com.zarnkina.mobile.utils.getParcelableSafely
...
class VMActivity : BaseAppCompatActivity(), SurfaceTextureListener, SurfaceHolder.Callback {
    ...
    override fun onSurfaceTextureAvailable(surface: SurfaceTexture, width: Int, height: Int) {
        ...
        CallbackBridge.setDirectGamepadEnableHandler {
            LoggerBridge.append("ZarnkinaMobile: Direct gamepad handler enabled")
        }
        if (vmViewModel.isRunning) {
