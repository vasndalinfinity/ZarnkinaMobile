...
package com.zarnkina.mobile.ui.theme
...
import com.zarnkina.mobile.ui.theme.components.activeMaskView
import com.zarnkina.mobile.utils.festival.Festival
...
private val zarnkinaLight = lightColorScheme(
    primary = Color(0xFF8F2BC2),
    onPrimary = Color.White,
    primaryContainer = Color(0xFFEED9FF),
    onPrimaryContainer = Color(0xFF2E0644),
    secondary = Color(0xFF765080),
    onSecondary = Color.White,
    secondaryContainer = Color(0xFFF0D9F7),
    onSecondaryContainer = Color(0xFF2A1234),
    tertiary = Color(0xFF7A4E8D),
    onTertiary = Color.White,
    tertiaryContainer = Color(0xFFF2DAFF),
    onTertiaryContainer = Color(0xFF2D123D),
    background = Color(0xFFFAF7FF),
    onBackground = Color(0xFF211827),
    surface = Color(0xFFFAF7FF),
    onSurface = Color(0xFF211827),
    surfaceVariant = Color(0xFFECE1F0),
    onSurfaceVariant = Color(0xFF514457),
    outline = Color(0xFF827187),
    outlineVariant = Color(0xFFD5C6D9),
)

private val zarnkinaDark = darkColorScheme(
    primary = Color(0xFFD38BFF),
    onPrimary = Color(0xFF47006B),
    primaryContainer = Color(0xFF6E2392),
    onPrimaryContainer = Color(0xFFF6DFFF),
    secondary = Color(0xFFD9B8E8),
    onSecondary = Color(0xFF3B2148),
    secondaryContainer = Color(0xFF553764),
    onSecondaryContainer = Color(0xFFF4DFFF),
    tertiary = Color(0xFFE5B7FF),
    onTertiary = Color(0xFF401452),
    tertiaryContainer = Color(0xFF5A2670),
    onTertiaryContainer = Color(0xFFF7D9FF),
    background = Color(0xFF0D0915),
    onBackground = Color(0xFFF5EAF8),
    surface = Color(0xFF120D1B),
    onSurface = Color(0xFFF5EAF8),
    surfaceVariant = Color(0xFF21132D),
    onSurfaceVariant = Color(0xFFD0BBD6),
    outline = Color(0xFF8D7098),
    outlineVariant = Color(0xFF493651),
)

@Composable
fun ZarnkinaMobileTheme(
    ...
    val targetColorScheme = remember(darkTheme) {
        if (darkTheme) zarnkinaDark else zarnkinaLight
    }
