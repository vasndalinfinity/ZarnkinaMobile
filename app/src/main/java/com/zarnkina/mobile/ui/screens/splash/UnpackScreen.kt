...
package com.zarnkina.mobile.ui.screens.splash
    ...
    BaseScreen(
        ...
        Column(
            ...
            Column(
                ...
                Text(
                    text = "ZARNKINA MOBILE",
                    color = MaterialTheme.colorScheme.primary,
                    style = MaterialTheme.typography.labelMedium
                )
                Text(
                    text = "İlk kurulum için hazırla",
                    color = MaterialTheme.colorScheme.onBackground,
                    style = MaterialTheme.typography.headlineSmall
                )
                Text(
                    text = "Minecraft için gerekli Java ve launcher bileşenlerini mor temalı kurulum ekranından indir.",
