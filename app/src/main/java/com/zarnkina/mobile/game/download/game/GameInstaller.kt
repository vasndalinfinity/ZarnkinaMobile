...
package com.zarnkina.mobile.game.download.game

import android.content.Context
import android.content.Intent
import com.zarnkina.mobile.R
import com.zarnkina.mobile.context.GlobalContext
import com.zarnkina.mobile.coroutine.Task
import com.zarnkina.mobile.coroutine.TaskFlowExecutor
import com.zarnkina.mobile.coroutine.TitledTask
import com.zarnkina.mobile.coroutine.addTask
import com.zarnkina.mobile.coroutine.buildPhase
import com.zarnkina.mobile.game.addons.mirror.mapBMCLMirrorUrls
import com.zarnkina.mobile.game.addons.modloader.ModLoader
import com.zarnkina.mobile.game.addons.modloader.cleanroom.CleanroomVersion
import com.zarnkina.mobile.game.addons.modloader.fabriclike.FabricLikeVersion
import com.zarnkina.mobile.game.addons.modloader.forgelike.ForgeLikeVersion
import com.zarnkina.mobile.game.addons.modloader.forgelike.neoforge.NeoForgeVersion
import com.zarnkina.mobile.game.addons.modloader.modlike.ModVersion
import com.zarnkina.mobile.game.download.assets.platform.mcim.mapMCIMMirrorUrls
import com.zarnkina.mobile.game.download.game.cleanroom.getCleanroomDownloadTask
import com.zarnkina.mobile.game.download.game.cleanroom.targetTempCleanroomInstaller
import com.zarnkina.mobile.game.download.game.fabric.getFabricLikeCompleterTask
import com.zarnkina.mobile.game.download.game.fabric.getFabricLikeDownloadTask
import com.zarnkina.mobile.game.download.game.forge.getForgeLikeAnalyseTask
import com.zarnkina.mobile.game.download.game.forge.getForgeLikeDownloadTask
import com.zarnkina.mobile.game.download.game.forge.getForgeLikeInstallTask
import com.zarnkina.mobile.game.download.game.forge.isNeoForge
import com.zarnkina.mobile.game.download.game.forge.targetTempForgeLikeInstaller
import com.zarnkina.mobile.game.download.game.optifine.getOptiFineDownloadTask
import com.zarnkina.mobile.game.download.game.optifine.getOptiFineInstallTask
import com.zarnkina.mobile.game.download.game.optifine.getOptiFineModsDownloadTask
import com.zarnkina.mobile.game.download.game.optifine.targetTempOptiFineInstaller
import com.zarnkina.mobile.game.download.jvm_server.JVMSocketServer
import com.zarnkina.mobile.game.download.jvm_server.JvmService
import com.zarnkina.mobile.game.path.getGameHome
import com.zarnkina.mobile.game.version.download.BaseMinecraftDownloader
import com.zarnkina.mobile.game.version.download.MinecraftDownloader
import com.zarnkina.mobile.game.version.installed.VersionConfig
...
import com.zarnkina.mobile.utils.file.copyDirectoryContents
import com.zarnkina.mobile.utils.logging.Logger
import com.zarnkina.mobile.utils.network.downloadFileFromSources
import com.zarnkina.mobile.utils.network.withSpeedReport
